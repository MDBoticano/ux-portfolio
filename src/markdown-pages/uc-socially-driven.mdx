...
### Summary
We were challenged with creating a novel social experience. We decided to
focus on the stigma of UC San Diego being “socially dead.” In testing our
prototype, I played the role of a chatbot to so that we did not have to
deal with implementation. Our goal was to explore how AI might improve
social experiences.
...
commitment to social activities. Click [here](http://invis.io/SCAQP3R4A) to check out our prototype.
...
over meeting strangers. We scoped this problem into a local context:
peers at our university.
