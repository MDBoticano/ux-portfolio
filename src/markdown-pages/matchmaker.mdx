...
<MdxInlineLink
  pTextBefore="I was in charge of reaching out to industry professionals on "
  aText="Product Hunt"
  link="https://www.producthunt.com/"
  pTextAfter="
    . We believed Product Hunt could be a source of clients for the platform. We
    contacted the teams behind 50 trending ideas to gauge their interest. We
    A/B tested our outreach email to see which type of wording garnered the
    most interest, though we found no discernible difference in responses."
/>
...
development. Though the project has transformed and exchanged hands, the
demonstrated value of the platform only predicts success.
